...
public class Location extends Weibo {
	...
	public JSONObject getMapImageByCenter(String centerCoordinate) throws WeiboException {
		return client
				.get(WeiboConfig.getValue("baseURL") + "location/base/get_map_image.json",
						new PostParameter[] { new PostParameter("center_coordinate", centerCoordinate) }, access_token)
				.asJSONObject();
	}
	...
	public JSONObject getMapImageByCity(String city) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/base/get_map_image.json",
				new PostParameter[] { new PostParameter("city", city) }, access_token).asJSONObject();
	}
	...
	public JSONObject getMapImage(Map<String, String> map) throws WeiboException {
		...
		return client.get(WeiboConfig.getValue("baseURL") + "location/base/get_map_image.json", parList, access_token)
				.asJSONObject();
	}
	...
	public List<Geos> ipToGeo(String ip) throws WeiboException {
		return Geos.constructGeos(client.get(WeiboConfig.getValue("baseURL") + "location/geo/ip_to_geo.json",
				new PostParameter[] { new PostParameter("ip", ip) }, access_token));
	}
	...
	public List<Geos> addressToGeo(String address) throws WeiboException {
		return Geos.constructGeos(client.get(WeiboConfig.getValue("baseURL") + "location/geo/address_to_geo.json",
				new PostParameter[] { new PostParameter("address", address) }, access_token));
	}
	...
	public List<Geos> geoToAddress(String coordinate) throws WeiboException {
		return Geos.constructGeos(client.get(WeiboConfig.getValue("baseURL") + "location/geo/geo_to_address.json",
				new PostParameter[] { new PostParameter("coordinate", coordinate) }, access_token));
	}
	...
	public JSONObject gpsToOffset(String coordinate) throws WeiboException {
		return client
				.get(WeiboConfig.getValue("baseURL") + "location/geo/gps_to_offset.json",
						new PostParameter[] { new PostParameter("coordinate", coordinate) }, access_token)
				.asJSONObject();
	}
	...
	public JSONObject isDomestic(String coordinates) throws WeiboException {
		return client
				.get(WeiboConfig.getValue("baseURL") + "location/geo/is_domestic.json",
						new PostParameter[] { new PostParameter("coordinates", coordinates) }, access_token)
				.asJSONObject();
	}
	...
	public List<Poisition> searchPoisByLocationByQ(String q) throws WeiboException {
		return Poisition
				.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_location.json",
						new PostParameter[] { new PostParameter("q", q) }, access_token));
	}
	...
	public List<Poisition> searchPoisByLocationByCategory(String category) throws WeiboException {
		return Poisition
				.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_location.json",
						new PostParameter[] { new PostParameter("category", category) }, access_token));
	}
	...
	public List<Poisition> searchPoisByLocation(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Poisition.constructPois(client
				.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_location.json", parList, access_token));
	}
	...
	public JSONObject searchPoisByGeoByQ(String q) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_geo.json",
				new PostParameter[] { new PostParameter("q", q) }, access_token).asJSONObject();
	}
	...
	public JSONObject searchPoisByGeoByCoordinate(String q, String coordinate) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_geo.json",
				new PostParameter[] { new PostParameter("q", q), new PostParameter("coordinate", coordinate) },
	...
	public JSONObject searchPoisByGeoByCenname(String q, String cenname) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_geo.json",
				new PostParameter[] { new PostParameter("q", q), new PostParameter("cenname", cenname) }, access_token)
				.asJSONObject();
	}
	...
	public JSONObject searchPoisByGeo(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_geo.json", parList, access_token)
				.asJSONObject();
	}
	...
	public List<Poisition> searchPoisByAreaByQ(String q, String coordinates) throws WeiboException {
		return Poisition.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_area.json",
	...
	public List<Poisition> searchPoisByAreaByCategory(String category, String coordinates) throws WeiboException {
		return Poisition.constructPois(client.get(
				WeiboConfig.getValue("baseURL") + "location/pois/search/by_area.json", new PostParameter[] {
	...
	public List<Poisition> showPoisBatch(String srcids) throws WeiboException {
		return Poisition.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/show_batch.json",
				new PostParameter[] { new PostParameter("srcids", srcids) }, access_token));
	}
	 ...
	 * @since JDK 1.5
	 */
	public Poisition addPois(String srcid, String name, String address, String cityName, String category,
			String longitude, String latitude) throws WeiboException {
		return new Poisition(client.post(WeiboConfig.getValue("baseURL") + "location/pois/add.json",
				new PostParameter[] { new PostParameter("srcid", srcid), new PostParameter("name", name),
						new PostParameter("address", address), new PostParameter("city_name", cityName),
						new PostParameter("category", category), new PostParameter("latitude", latitude),
	...
	public Poisition addPois(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return new Poisition(
				client.post(WeiboConfig.getValue("baseURL") + "location/pois/add.json", parList, access_token));
	}
	...
	public JSONObject getLocation(String json) throws WeiboException {
		return client.post(WeiboConfig.getValue("baseURL") + "location/mobile/get_location.json",
				new PostParameter[] { new PostParameter("json", json) }, access_token).asJSONObject();
	}
	...
	public JSONObject searchDriveRouteByPid(String beginPid, String endPid) throws WeiboException {
		return client
				.get(WeiboConfig.getValue("baseURL") + "location/line/drive_route.json", new PostParameter[] {
						new PostParameter("begin_pid", beginPid), new PostParameter("end_pid", endPid) }, access_token)
				.asJSONObject();
	}
	...
	public JSONObject searchDriveRouteByCoordinate(String beginCoordinate, String endCoordinate) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/drive_route.json",
				new PostParameter[] { new PostParameter("begin_coordinate", beginCoordinate),
	...
	public JSONObject searchDriveRoute(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/drive_route.json", parList, access_token)
				.asJSONObject();
	}
	...
	public JSONObject searchBusRouteByPid(String beingPid, String endPid) throws WeiboException {
		return client
				.get(WeiboConfig.getValue("baseURL") + "location/line/bus_route.json", new PostParameter[] {
						new PostParameter("being_pid", beingPid), new PostParameter("end_pid", endPid) }, access_token)
				.asJSONObject();
	}
	...
	public JSONObject searchBusRouteByCoordinate(String beginCoordinate, String endCoordinate) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/bus_route.json",
				new PostParameter[] { new PostParameter("begin_coordinate", beginCoordinate),
						new PostParameter("end_coordinate", endCoordinate) },
				access_token).asJSONObject();
	}
	...
	public JSONObject searchBusRoute(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/bus_route.json", parList, access_token)
				.asJSONObject();
	}
	...
	public JSONObject searchBusLine(String q) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/bus_line.json",
				new PostParameter[] { new PostParameter("q", q) }, access_token).asJSONObject();
	}
	...
	public JSONObject searchBusLine(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/bus_line.json", parList, access_token)
				.asJSONObject();
	}
	...
	public JSONObject searchBusStation(String q) throws WeiboException {
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/bus_station.json",
				new PostParameter[] { new PostParameter("q", q) }, access_token).asJSONObject();
	}
	...
	public JSONObject searchBusStation(Map<String, String> map) throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(WeiboConfig.getValue("baseURL") + "location/line/bus_station.json", parList, access_token)
				.asJSONObject();
	}
