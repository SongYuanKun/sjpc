$(function() {
	$("#sparkline1").sparkline([ 34, 43, 43, 35, 44, 32, 44, 52, 25 ], {
		...
		sliceColors : [ "#1ab394", "#b3b3b3", "#e4f0fb" ]
			...
			[ 34, 43, 43, 35, 44, 32, 15, 22, 46, 33, 86, 54, 73, 53, 12, 53,
					23, 65, 23, 63, 53, 42, 34, 56, 76, 15, 54, 23, 44 ], {
				type : "line",
				lineColor : "#17997f",
				fillColor : "#ffffff"
			...
			[ 4, 6, 7, 7, 4, 3, 2, 1, 4, 4, 5, 6, 3, 4, 5, 8, 7, 6, 9, 3, 2, 4,
					1, 5, 6, 4, 3, 7 ], {
				type : "discrete",
				lineColor : "#1ab394"
		...
		sliceColors : [ "#1ab394", "#b3b3b3", "#e4f0fb" ]
			...
			[ 5, 6, 7, 2, 0, 4, 2, 4, 5, 7, 2, 4, 12, 14, 4, 2, 14, 12, 7 ], {
				type : "bar",
				barWidth : 8,
				height : "150px",
				barColor : "#1ab394",
